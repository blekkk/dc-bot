...
import helpData from '../datasource/const';
...
const handleHelpReact = (client: Message, message: string[]) => {
  switch (message[2]) {
    case 'sfwbooru':
      client.reply(helpData.sfwbooru);
      break;
    case 'nsfwbooru':
      client.reply(helpData.nsfwbooru);
      break;
    case 'emojify':
...
export { handleHelp, handleHelpReact };